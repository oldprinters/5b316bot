...
import { selectRoleMenu } from '../keyboards/keyboards.js'
...
durationLesson.hears(/^\d{1,3}$/, async ctx => {
    ...
    await ctx.reply('Выберите роль в меню:', selectRoleMenu())
})
//-----------------------------------------
